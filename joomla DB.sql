...
CREATE DATABASE IF NOT EXISTS `food_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `food_db`;

-- Dumping structure for table food_db.food_action_logs
CREATE TABLE IF NOT EXISTS `food_action_logs` (
...
-- Dumping data for table food_db.food_action_logs: ~6 rows (approximately)
/*!40000 ALTER TABLE `food_action_logs` DISABLE KEYS */;
INSERT INTO `food_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
	(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"223","username":"fos","accountlink":"index.php?option=com_users&task=user.edit&id=223","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR"}', '2020-04-28 03:53:30', 'com_users', 223, 0, 'COM_ACTIONLOGS_DISABLED'),
	(2, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{"action":"add","type":"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE","id":7,"title":"test","itemlink":"index.php?option=com_content&task=article.edit&id=7","userid":"223","username":"fos","accountlink":"index.php?option=com_users&task=user.edit&id=223"}', '2020-04-28 03:59:34', 'com_content.article', 223, 7, 'COM_ACTIONLOGS_DISABLED'),
	(3, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{"action":"update","type":"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY","id":2,"title":"Uncategorised","itemlink":"index.php?option=com_categories&task=category.edit&id=2","userid":"223","username":"fos","accountlink":"index.php?option=com_users&task=user.edit&id=223"}', '2020-04-28 04:00:15', 'com_categories.category', 223, 2, 'COM_ACTIONLOGS_DISABLED'),
	(4, 'PLG_ACTIONLOG_JOOMLA_USER_CHECKIN', '{"action":"checkin","type":"PLG_ACTIONLOG_JOOMLA_TYPE_USER","id":"223","title":"fos","itemlink":"index.php?option=com_users&task=user.edit&id=223","userid":"223","username":"fos","accountlink":"index.php?option=com_users&task=user.edit&id=223","table":"#__categories"}', '2020-04-28 04:00:15', 'com_checkin', 223, 223, 'COM_ACTIONLOGS_DISABLED'),
	(5, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{"action":"update","type":"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY","id":2,"title":"Uncategorised","itemlink":"index.php?option=com_categories&task=category.edit&id=2","userid":"223","username":"fos","accountlink":"index.php?option=com_users&task=user.edit&id=223"}', '2020-04-28 04:00:20', 'com_categories.category', 223, 2, 'COM_ACTIONLOGS_DISABLED'),
	(6, 'PLG_ACTIONLOG_JOOMLA_USER_CHECKIN', '{"action":"checkin","type":"PLG_ACTIONLOG_JOOMLA_TYPE_USER","id":"223","title":"fos","itemlink":"index.php?option=com_users&task=user.edit&id=223","userid":"223","username":"fos","accountlink":"index.php?option=com_users&task=user.edit&id=223","table":"#__categories"}', '2020-04-28 04:00:20', 'com_checkin', 223, 223, 'COM_ACTIONLOGS_DISABLED');
/*!40000 ALTER TABLE `food_action_logs` ENABLE KEYS */;

-- Dumping structure for table food_db.food_action_logs_extensions
CREATE TABLE IF NOT EXISTS `food_action_logs_extensions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_action_logs_extensions: ~18 rows (approximately)
/*!40000 ALTER TABLE `food_action_logs_extensions` DISABLE KEYS */;
INSERT INTO `food_action_logs_extensions` (`id`, `extension`) VALUES
	(1, 'com_banners'),
	(2, 'com_cache'),
	(3, 'com_categories'),
	(4, 'com_config'),
...
-- Dumping structure for table food_db.food_action_logs_users
CREATE TABLE IF NOT EXISTS `food_action_logs_users` (
...
-- Dumping data for table food_db.food_action_logs_users: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_action_logs_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_action_logs_users` ENABLE KEYS */;

-- Dumping structure for table food_db.food_action_log_config
CREATE TABLE IF NOT EXISTS `food_action_log_config` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_action_log_config: ~19 rows (approximately)
/*!40000 ALTER TABLE `food_action_log_config` DISABLE KEYS */;
INSERT INTO `food_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
-- Dumping structure for table food_db.food_assets
...
-- Dumping data for table food_db.food_assets: ~47 rows (approximately)
/*!40000 ALTER TABLE `food_assets` DISABLE KEYS */;
INSERT INTO `food_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(27, 35, 27, 34, 3, 'com_content.category.2', 'Uncategorised', '{}'),
	...
	(35, 8, 18, 35, 2, 'com_content.category.9', 'Blog', '{}'),
	(36, 27, 28, 29, 4, 'com_content.article.1', 'About', '{}'),
	(37, 27, 30, 31, 4, 'com_content.article.2', 'Working on Your Site', '{}'),
	(38, 35, 19, 20, 3, 'com_content.article.3', 'Welcome to your blog', '{}'),
	(39, 35, 21, 22, 3, 'com_content.article.4', 'About your home page', '{}'),
	(40, 35, 23, 24, 3, 'com_content.article.5', 'Your Modules', '{}'),
	(41, 1, 77, 78, 1, 'com_users.category.10', 'Uncategorised', '{}'),
	(42, 1, 79, 80, 1, 'com_joomlaupdate', 'com_joomlaupdate', '{}'),
	(43, 35, 25, 26, 3, 'com_content.article.6', 'Your Template', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
	...
	(50, 27, 32, 33, 4, 'com_content.article.7', 'test', '{}');
/*!40000 ALTER TABLE `food_assets` ENABLE KEYS */;

-- Dumping structure for table food_db.food_associations
CREATE TABLE IF NOT EXISTS `food_associations` (
...
-- Dumping data for table food_db.food_associations: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_associations` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_associations` ENABLE KEYS */;

-- Dumping structure for table food_db.food_banners
CREATE TABLE IF NOT EXISTS `food_banners` (
...
-- Dumping data for table food_db.food_banners: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_banners` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_banners` ENABLE KEYS */;

-- Dumping structure for table food_db.food_banner_clients
CREATE TABLE IF NOT EXISTS `food_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- Dumping data for table food_db.food_banner_clients: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_banner_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_banner_clients` ENABLE KEYS */;

-- Dumping structure for table food_db.food_banner_tracks
CREATE TABLE IF NOT EXISTS `food_banner_tracks` (
...
-- Dumping data for table food_db.food_banner_tracks: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_banner_tracks` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_banner_tracks` ENABLE KEYS */;

-- Dumping structure for table food_db.food_categories
...
-- Dumping data for table food_db.food_categories: ~7 rows (approximately)
/*!40000 ALTER TABLE `food_categories` DISABLE KEYS */;
INSERT INTO `food_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
	(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 223, '2020-04-28 03:52:52', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(2, 27, 9, 10, 11, 2, 'blog/uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 223, '2020-04-28 03:52:52', 223, '2020-04-28 04:00:20', 0, '*', 1),
	(3, 28, 1, 1, 2, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 223, '2020-04-28 03:52:52', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(4, 29, 1, 3, 4, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 223, '2020-04-28 03:52:52', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(5, 30, 1, 5, 6, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 223, '2020-04-28 03:52:52', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(7, 32, 1, 7, 8, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 223, '2020-04-28 03:52:52', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(9, 35, 1, 9, 12, 1, 'blog', 'com_content', 'Blog', 'blog', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 223, '2020-04-28 03:52:52', 0, '0000-00-00 00:00:00', 0, '*', 1);
/*!40000 ALTER TABLE `food_categories` ENABLE KEYS */;

-- Dumping structure for table food_db.food_contact_details
CREATE TABLE IF NOT EXISTS `food_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_contact_details: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_contact_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_contact_details` ENABLE KEYS */;

-- Dumping structure for table food_db.food_content
...
-- Dumping data for table food_db.food_contentitem_tag_map: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_contentitem_tag_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_contentitem_tag_map` ENABLE KEYS */;

-- Dumping structure for table food_db.food_content_frontpage
CREATE TABLE IF NOT EXISTS `food_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_content_frontpage: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_content_frontpage` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_content_frontpage` ENABLE KEYS */;

-- Dumping structure for table food_db.food_content_rating
CREATE TABLE IF NOT EXISTS `food_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
-- Dumping data for table food_db.food_content_rating: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_content_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_content_rating` ENABLE KEYS */;

-- Dumping structure for table food_db.food_content_types
CREATE TABLE IF NOT EXISTS `food_content_types` (
...
-- Dumping data for table food_db.food_content_types: ~13 rows (approximately)
/*!40000 ALTER TABLE `food_content_types` DISABLE KEYS */;
INSERT INTO `food_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
-- Dumping structure for table food_db.food_core_log_searches
CREATE TABLE IF NOT EXISTS `food_core_log_searches` (
  `search_term` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_core_log_searches: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_core_log_searches` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_core_log_searches` ENABLE KEYS */;

-- Dumping structure for table food_db.food_extensions
CREATE TABLE IF NOT EXISTS `food_extensions` (
...
-- Dumping data for table food_db.food_extensions: ~183 rows (approximately)
/*!40000 ALTER TABLE `food_extensions` DISABLE KEYS */;
INSERT INTO `food_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"e0c3cd03f009fc94f35aeab37f122d77"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	...
	(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1588045994}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
-- Dumping structure for table food_db.food_fields
CREATE TABLE IF NOT EXISTS `food_fields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_fields: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_fields` ENABLE KEYS */;

-- Dumping structure for table food_db.food_fields_categories
CREATE TABLE IF NOT EXISTS `food_fields_categories` (
  `field_id` int(11) NOT NULL DEFAULT 0,
  `category_id` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`field_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_fields_categories: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_fields_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_fields_categories` ENABLE KEYS */;

-- Dumping structure for table food_db.food_fields_groups
CREATE TABLE IF NOT EXISTS `food_fields_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- Dumping data for table food_db.food_fields_groups: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_fields_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_fields_groups` ENABLE KEYS */;

-- Dumping structure for table food_db.food_fields_values
CREATE TABLE IF NOT EXISTS `food_fields_values` (
...
-- Dumping data for table food_db.food_fields_values: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_fields_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_fields_values` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_filters
CREATE TABLE IF NOT EXISTS `food_finder_filters` (
...
-- Dumping data for table food_db.food_finder_filters: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_filters` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_filters` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links
CREATE TABLE IF NOT EXISTS `food_finder_links` (
...
-- Dumping data for table food_db.food_finder_links: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms0
CREATE TABLE IF NOT EXISTS `food_finder_links_terms0` (
...
-- Dumping data for table food_db.food_finder_links_terms0: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms0` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms0` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms1
CREATE TABLE IF NOT EXISTS `food_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms1: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms1` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms1` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms2
CREATE TABLE IF NOT EXISTS `food_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms2: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms2` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms2` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms3
CREATE TABLE IF NOT EXISTS `food_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms3: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms3` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms3` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms4
CREATE TABLE IF NOT EXISTS `food_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms4: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms4` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms4` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms5
CREATE TABLE IF NOT EXISTS `food_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms5: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms5` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms5` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms6
CREATE TABLE IF NOT EXISTS `food_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms6: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms6` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms6` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms7
CREATE TABLE IF NOT EXISTS `food_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms7: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms7` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms7` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms8
CREATE TABLE IF NOT EXISTS `food_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms8: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms8` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms8` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_terms9
CREATE TABLE IF NOT EXISTS `food_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_terms9: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_terms9` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_terms9` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_termsa
CREATE TABLE IF NOT EXISTS `food_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_termsa: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_termsa` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_termsa` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_termsb
CREATE TABLE IF NOT EXISTS `food_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_termsb: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_termsb` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_termsb` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_termsc
CREATE TABLE IF NOT EXISTS `food_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_termsc: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_termsc` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_termsc` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_termsd
CREATE TABLE IF NOT EXISTS `food_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_termsd: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_termsd` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_termsd` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_termse
CREATE TABLE IF NOT EXISTS `food_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_termse: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_termse` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_termse` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_links_termsf
CREATE TABLE IF NOT EXISTS `food_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table food_db.food_finder_links_termsf: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_links_termsf` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_links_termsf` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_taxonomy
CREATE TABLE IF NOT EXISTS `food_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT 0,
  `title` varchar(255) NOT NULL,
...
-- Dumping data for table food_db.food_finder_taxonomy: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_finder_taxonomy` DISABLE KEYS */;
INSERT INTO `food_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
	(1, 0, 'ROOT', 0, 0, 0);
/*!40000 ALTER TABLE `food_finder_taxonomy` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_taxonomy_map
CREATE TABLE IF NOT EXISTS `food_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
-- Dumping data for table food_db.food_finder_taxonomy_map: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_taxonomy_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_taxonomy_map` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_terms
CREATE TABLE IF NOT EXISTS `food_finder_terms` (
...
-- Dumping data for table food_db.food_finder_terms: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_terms` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_terms_common
CREATE TABLE IF NOT EXISTS `food_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
-- Dumping data for table food_db.food_finder_terms_common: ~110 rows (approximately)
/*!40000 ALTER TABLE `food_finder_terms_common` DISABLE KEYS */;
INSERT INTO `food_finder_terms_common` (`term`, `language`) VALUES
	('a', 'en'),
	('about', 'en'),
	('after', 'en'),
	('ago', 'en'),
...
-- Dumping structure for table food_db.food_finder_tokens
CREATE TABLE IF NOT EXISTS `food_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT 0,
...
-- Dumping data for table food_db.food_finder_tokens: 0 rows
/*!40000 ALTER TABLE `food_finder_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_tokens` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_tokens_aggregate
CREATE TABLE IF NOT EXISTS `food_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
-- Dumping data for table food_db.food_finder_tokens_aggregate: 0 rows
/*!40000 ALTER TABLE `food_finder_tokens_aggregate` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_tokens_aggregate` ENABLE KEYS */;

-- Dumping structure for table food_db.food_finder_types
CREATE TABLE IF NOT EXISTS `food_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_finder_types: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_finder_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_finder_types` ENABLE KEYS */;

-- Dumping structure for table food_db.food_languages
...
-- Dumping data for table food_db.food_languages: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_languages` DISABLE KEYS */;
INSERT INTO `food_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
	(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);
/*!40000 ALTER TABLE `food_languages` ENABLE KEYS */;

-- Dumping structure for table food_db.food_menu
...
-- Dumping data for table food_db.food_menu: ~32 rows (approximately)
/*!40000 ALTER TABLE `food_menu` DISABLE KEYS */;
INSERT INTO `food_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
-- Dumping structure for table food_db.food_menu_types
CREATE TABLE IF NOT EXISTS `food_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Dumping data for table food_db.food_menu_types: ~3 rows (approximately)
/*!40000 ALTER TABLE `food_menu_types` DISABLE KEYS */;
INSERT INTO `food_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
	(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0),
	(2, 0, 'authormenu', 'Author Menu', '', 0),
	(3, 0, 'bottommenu', 'Bottom Menu', '', 0);
/*!40000 ALTER TABLE `food_menu_types` ENABLE KEYS */;

-- Dumping structure for table food_db.food_messages
...
-- Dumping data for table food_db.food_messages: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_messages` ENABLE KEYS */;

-- Dumping structure for table food_db.food_messages_cfg
CREATE TABLE IF NOT EXISTS `food_messages_cfg` (
...
-- Dumping data for table food_db.food_messages_cfg: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_messages_cfg` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_messages_cfg` ENABLE KEYS */;

-- Dumping structure for table food_db.food_modules
CREATE TABLE IF NOT EXISTS `food_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
-- Dumping data for table food_db.food_modules: ~27 rows (approximately)
/*!40000 ALTER TABLE `food_modules` DISABLE KEYS */;
INSERT INTO `food_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
-- Dumping structure for table food_db.food_modules_menu
CREATE TABLE IF NOT EXISTS `food_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_modules_menu: ~29 rows (approximately)
/*!40000 ALTER TABLE `food_modules_menu` DISABLE KEYS */;
INSERT INTO `food_modules_menu` (`moduleid`, `menuid`) VALUES
	(1, 0),
	(2, 0),
	(3, 0),
	(4, 0),
...
-- Dumping structure for table food_db.food_newsfeeds
CREATE TABLE IF NOT EXISTS `food_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_newsfeeds: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_newsfeeds` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_newsfeeds` ENABLE KEYS */;

-- Dumping structure for table food_db.food_overrider
CREATE TABLE IF NOT EXISTS `food_overrider` (
...
-- Dumping data for table food_db.food_overrider: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_overrider` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_overrider` ENABLE KEYS */;

-- Dumping structure for table food_db.food_postinstall_messages
CREATE TABLE IF NOT EXISTS `food_postinstall_messages` (
...
-- Dumping data for table food_db.food_postinstall_messages: ~9 rows (approximately)
/*!40000 ALTER TABLE `food_postinstall_messages` DISABLE KEYS */;
INSERT INTO `food_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
-- Dumping structure for table food_db.food_privacy_consents
CREATE TABLE IF NOT EXISTS `food_privacy_consents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Dumping data for table food_db.food_privacy_consents: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_privacy_consents` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_privacy_consents` ENABLE KEYS */;

-- Dumping structure for table food_db.food_privacy_requests
CREATE TABLE IF NOT EXISTS `food_privacy_requests` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_privacy_requests: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_privacy_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_privacy_requests` ENABLE KEYS */;

-- Dumping structure for table food_db.food_redirect_links
CREATE TABLE IF NOT EXISTS `food_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_redirect_links: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_redirect_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_redirect_links` ENABLE KEYS */;

-- Dumping structure for table food_db.food_schemas
CREATE TABLE IF NOT EXISTS `food_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_schemas: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_schemas` DISABLE KEYS */;
INSERT INTO `food_schemas` (`extension_id`, `version_id`) VALUES
	(700, '3.9.16-2020-03-04');
/*!40000 ALTER TABLE `food_schemas` ENABLE KEYS */;

-- Dumping structure for table food_db.food_session
CREATE TABLE IF NOT EXISTS `food_session` (
...
-- Dumping data for table food_db.food_session: ~2 rows (approximately)
/*!40000 ALTER TABLE `food_session` DISABLE KEYS */;
INSERT INTO `food_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	(_binary 0x367436386E716F61316765316871616E34613331313966353262, 0, 1, 1588046423, 'joomla|s:880:"";', 0, ''),
	(_binary 0x6565643163397566396E6A716733676867653361317238396F74, 1, 0, 1588046422, 'joomla|s:1640:"";', 223, 'fos');
/*!40000 ALTER TABLE `food_session` ENABLE KEYS */;

-- Dumping structure for table food_db.food_tags
...
-- Dumping data for table food_db.food_tags: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_tags` DISABLE KEYS */;
INSERT INTO `food_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
	(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 223, '2020-04-28 03:52:52', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `food_tags` ENABLE KEYS */;

-- Dumping structure for table food_db.food_template_styles
CREATE TABLE IF NOT EXISTS `food_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_template_styles: ~4 rows (approximately)
/*!40000 ALTER TABLE `food_template_styles` DISABLE KEYS */;
INSERT INTO `food_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
-- Dumping structure for table food_db.food_ucm_base
CREATE TABLE IF NOT EXISTS `food_ucm_base` (
...
-- Dumping data for table food_db.food_ucm_base: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_ucm_base` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_ucm_base` ENABLE KEYS */;

-- Dumping structure for table food_db.food_ucm_content
CREATE TABLE IF NOT EXISTS `food_ucm_content` (
...
-- Dumping data for table food_db.food_ucm_content: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_ucm_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_ucm_content` ENABLE KEYS */;

-- Dumping structure for table food_db.food_ucm_history
CREATE TABLE IF NOT EXISTS `food_ucm_history` (
...
-- Dumping data for table food_db.food_ucm_history: ~2 rows (approximately)
/*!40000 ALTER TABLE `food_ucm_history` DISABLE KEYS */;
INSERT INTO `food_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
	(1, 7, 1, '', '2020-04-28 03:59:34', 223, 1758, '0f5ada76d3f156ae122fd08152953dd1c1a80f58', '{"id":7,"asset_id":50,"title":"test","alias":"test","introtext":"<p>test 1<\\/p>","fulltext":"","state":1,"catid":"2","created":"2020-04-28 03:59:34","created_by":"223","created_by_alias":"","modified":"2020-04-28 03:59:34","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2020-04-28 03:59:34","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"article_layout\\":\\"\\",\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_associations\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_page_title\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":"","note":""}', 0),
	(2, 2, 5, '', '2020-04-28 04:00:15', 223, 594, '2a72bff93bc898c6a0092b320e295b82bc90f8f2', '{"id":2,"asset_id":"27","parent_id":"9","lft":"10","rgt":11,"level":2,"path":"uncategorised","extension":"com_content","title":"Uncategorised","alias":"uncategorised","note":"","description":"","published":"1","checked_out":"223","checked_out_time":"2020-04-28 04:00:02","access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"223","created_time":"2020-04-28 03:52:52","modified_user_id":"223","modified_time":"2020-04-28 04:00:15","hits":"0","language":"*","version":"1"}', 0);
/*!40000 ALTER TABLE `food_ucm_history` ENABLE KEYS */;

-- Dumping structure for table food_db.food_updates
...
-- Dumping data for table food_db.food_updates: ~77 rows (approximately)
/*!40000 ALTER TABLE `food_updates` DISABLE KEYS */;
INSERT INTO `food_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
-- Dumping structure for table food_db.food_update_sites
CREATE TABLE IF NOT EXISTS `food_update_sites` (
...
-- Dumping data for table food_db.food_update_sites: ~3 rows (approximately)
/*!40000 ALTER TABLE `food_update_sites` DISABLE KEYS */;
INSERT INTO `food_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1588045997, ''),
	(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1588046028, ''),
	(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1588046029, '');
/*!40000 ALTER TABLE `food_update_sites` ENABLE KEYS */;

-- Dumping structure for table food_db.food_update_sites_extensions
CREATE TABLE IF NOT EXISTS `food_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

-- Dumping data for table food_db.food_update_sites_extensions: ~3 rows (approximately)
/*!40000 ALTER TABLE `food_update_sites_extensions` DISABLE KEYS */;
INSERT INTO `food_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
	(1, 700),
	(2, 802),
	(3, 28);
/*!40000 ALTER TABLE `food_update_sites_extensions` ENABLE KEYS */;

-- Dumping structure for table food_db.food_usergroups
CREATE TABLE IF NOT EXISTS `food_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
-- Dumping data for table food_db.food_usergroups: ~9 rows (approximately)
/*!40000 ALTER TABLE `food_usergroups` DISABLE KEYS */;
INSERT INTO `food_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
	(1, 0, 1, 18, 'Public'),
	(2, 1, 8, 15, 'Registered'),
	(3, 2, 9, 14, 'Author'),
	(4, 3, 10, 13, 'Editor'),
...
-- Dumping structure for table food_db.food_users
...
-- Dumping data for table food_db.food_users: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_users` DISABLE KEYS */;
INSERT INTO `food_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(223, 'Super User', 'fos', 'gayan.dharmarathna91@gmail.com', '$2y$10$33t39m5bmE7xYWfHibLpb.5uj4/MM2JGESdmr7gWWWg3NpLpbHimm', 0, 1, '2020-04-28 03:52:53', '2020-04-28 03:53:30', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
/*!40000 ALTER TABLE `food_users` ENABLE KEYS */;

-- Dumping structure for table food_db.food_user_keys
CREATE TABLE IF NOT EXISTS `food_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table food_db.food_user_keys: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_user_keys` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_user_keys` ENABLE KEYS */;

-- Dumping structure for table food_db.food_user_notes
CREATE TABLE IF NOT EXISTS `food_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT 0,
  `catid` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Dumping data for table food_db.food_user_notes: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_user_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_user_notes` ENABLE KEYS */;

-- Dumping structure for table food_db.food_user_profiles
CREATE TABLE IF NOT EXISTS `food_user_profiles` (
...
-- Dumping data for table food_db.food_user_profiles: ~0 rows (approximately)
/*!40000 ALTER TABLE `food_user_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_user_profiles` ENABLE KEYS */;

-- Dumping structure for table food_db.food_user_usergroup_map
CREATE TABLE IF NOT EXISTS `food_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_user_usergroup_map: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_user_usergroup_map` DISABLE KEYS */;
INSERT INTO `food_user_usergroup_map` (`user_id`, `group_id`) VALUES
	(223, 8);
/*!40000 ALTER TABLE `food_user_usergroup_map` ENABLE KEYS */;

-- Dumping structure for table food_db.food_utf8_conversion
CREATE TABLE IF NOT EXISTS `food_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table food_db.food_utf8_conversion: ~1 rows (approximately)
/*!40000 ALTER TABLE `food_utf8_conversion` DISABLE KEYS */;
INSERT INTO `food_utf8_conversion` (`converted`) VALUES
	(4);
/*!40000 ALTER TABLE `food_utf8_conversion` ENABLE KEYS */;

-- Dumping structure for table food_db.food_viewlevels
CREATE TABLE IF NOT EXISTS `food_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
-- Dumping data for table food_db.food_viewlevels: ~5 rows (approximately)
/*!40000 ALTER TABLE `food_viewlevels` DISABLE KEYS */;
INSERT INTO `food_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
	(1, 'Public', 0, '[1]'),
